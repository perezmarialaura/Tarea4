...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.55]{Tambor_init.png}
    \caption{Condición inicial del tambor.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.55]{Tambor_toctavos.png}
    \caption{Membrana después de T/8.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.55]{Tambor_tcuartos.png}
    \caption{Membrana después de T/4.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.55]{Tambor_tmedios.png}
